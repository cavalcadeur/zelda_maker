var Chuchu = function(){
    ...
    function walking(){
        ...
        x += vecteurs[sens][1]/80;
        y += vecteurs[sens][0]/80;
        n += 1;
        if (n%10 == 0){
            vision();
            var truc = react();
    ...
    function shrinking(){
        ...
        else if (z == getFloor(Math.floor(x),Math.floor(y),z)){
            this.doing = shrinked;
            shrink = 1;
        }
    }
    ...
    function shrinked(){
        ...
        if (rnd(100) == 1){
            this.doing = unshrinking;
        }
    }

    function unshrinking(){
        if (n == 0){
            g = 1;
            img = 19;
            z += 0.1;
    ...
    return {
        ...
        takeBack(){
            if (fm == 2) mort = 2;
            return [fx,fy,"chuchu",mort];
        },
        isThere(XX,YY,ZZ){
            if (shrink == 1) return false;
