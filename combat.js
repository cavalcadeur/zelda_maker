function hitSpot(x,y,z,degat,sens){
    ...
    if (Math.abs(z - niveau[y][x]) <= 1){
        if (truc == "herbe0" | truc == "herbe1" | truc == "pot" | truc == "palmier"){
            ...
            if (truc == "herbe0" || truc == "herbe1") particles.push({n:0,type:"herbe",x:x,y:y,g:5,alti:niveau[y][x],lim:10});
            else if (truc == "palmier") particles.push({n:0,type:"palmier",x:x,y:y,g:5,alti:niveau[y][x],lim:15});
        }
